...
public class GraphicsWindow extends JFrame {
    ...
    public void setPage(int pageNum) {
        synchronized (graphicsLock) {
            if (!pages.containsKey(pageNum)) {
                BufferedImage newPage = new BufferedImage(SCREEN_WIDTH, SCREEN_HEIGHT, BufferedImage.TYPE_INT_RGB);
                Graphics2D g = null;
                try {
    ...
    public void copyPage(int fromPage, int toPage) {
        ...
        BufferedImage dest = new BufferedImage(SCREEN_WIDTH, SCREEN_HEIGHT, BufferedImage.TYPE_INT_RGB);
